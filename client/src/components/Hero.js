...
import CategoryNew from '../components/CategoryNav';
  ...
  return <section className='mb-[30px] pt-36 lg:pt-0 '>
    <div className="container mx-auto">
      <div className='flex flex-col gap-y-[30px] xl:flex-row xl:gap-x-[30px]'>
        ...
        <div className='grad flex-1 h-[250px] rounded-[8px] overflow-hidden relative
        p-6'>
        
        <div className='flex flex-col max-w-[144px] h-full
        justify-center'>
