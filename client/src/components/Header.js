 ...
 const [ catNavMobile, setCatnavMobile ] = useState(false);
  return <header className='bg-primary py-6 fixed w-full top-0 z-40 lg:relative xl:mb-[30px]'>
    ...
    <div className='flex flex-row gap-4 lg:items-center justify-between mb-4 xl:mb-0'>
      ...
      <div className={`${catNavMobile ? 'left-0' : '-left-full'} fixed top-0 bottom-0
    ...
    <div className='flex items-center gap-x-[10px]'>
      ...
      className='relative cursor-pointer'>
        ...
        text-primary absolute w-[18px] h-[18px] rounded-full top-3 -right-1 
        text-[13px] flex justify-center items-center font-bold tracking-[-0.1em]'>{itemsAmount}</div>
      </div>
      <div className={`
